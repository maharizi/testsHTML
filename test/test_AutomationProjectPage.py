...
def test_get_fname(locator, homepage):
    ...
    for name in data:
        try:
            ...
            testwriteToFile(f'{test_name} {param} {name[first_name]} {expected} :{name[first_name]} {test_pass}',
                            test_name)
        except:
            homepage.screenshot(test_name=test_name)
            testwriteToFile(f'{test_name} {param} {name[first_name]} {expected} :{name[first_name]} {test_fail}',
                            test_name)
...
def test_get_lname(locator, homepage):
    ...
    for name in data:
        try:
            ...
            testwriteToFile(f'{test_name} {param} {name[last_name]} {expected} {name[last_name]} {test_pass}',
                            test_name)
        except:
            homepage.screenshot(test_name=test_name)
            testwriteToFile(f'{test_name} {param} {name[last_name]} {expected} {name[last_name]} {test_fail}',
                            test_name)
...
def test_clear_button(locator, homepage):
    ...
    for name in data:
        ...
        try:
            ...
            testwriteToFile(f'{test_name} {param}\n{name}\n{test_pass}', test_name)
        except:
            homepage.screenshot(test_name=test_name)
            testwriteToFile(f'{test_name} {param}\n{name}\n{test_fail}', test_name)
...
def test_send_button(locator, homepage):
    ...
    for name in data:
        try:
            ...
            assert homepage.email_is_valid() == True
            testwriteToFile(
                f'{test_name} {param} first name:{name[first_name]} last name:{name[last_name]} email:{name[email]} {test_pass}',
                test_name)
        except:
            homepage.screenshot(test_name=test_name)
            testwriteToFile(
                f'{test_name} {param} first name:{name[first_name]} last name:{name[last_name]} email:{name[email]} {test_fail}\n',
                test_name)
